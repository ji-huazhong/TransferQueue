...
- [SimpleStorage](docs/storage_backends/simple_storage_ssd.md): The default 2-D storage backend, with optional
  Mooncake-backed local SSD/NVMe offload
  constraints and optional local-NVMe offload.
